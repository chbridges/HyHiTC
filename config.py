...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pretrain_epochs", "-pe", type=int, default=5)
    parser.add_argument("--pretrain_lr", "-plr", type=float, default=1e-4)
    ...
    parser.add_argument("--node_dim", "-nd", type=int, default=256)
    parser.add_argument("--seed", "-s", type=int, default=42)
    parser.add_argument("--test_data", "-test", default="slavicnlp2025")
    parser.add_argument("--train_data", "-train", default="semeval2023,slavicnlp2025,clef2024")
